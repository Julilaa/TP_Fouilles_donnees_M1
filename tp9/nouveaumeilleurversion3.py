...
# -------------------------------------------------------------------
# 2) Préprocessing : Normalisation (optionnel si tu le souhaites)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4) Instanciation des 3 modèles de base (avec paramètres que tu souhaites)
# -------------------------------------------------------------------
xgb_params = {
...
# OOF final du stacking (attention, c'est "in-sample" pour le méta)
...
# Pas de renommage, on garde le même nom que tu utilisais
