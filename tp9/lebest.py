...
# Vérification du nombre optimal d'arbres
...
# Stacking simple (moyenne XGB + CatBoost)
...
# Génération de la courbe ROC finale
fpr, tpr, _ = roc_curve(y_val, y_val_proba_ensemble)
auc_score = roc_auc_score(y_val, y_val_proba_ensemble)
